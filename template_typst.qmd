---
title: Results for a Project
running-head: Running head
author:
  - name: Awesome OCDO
    email: awesome@fredhutch.org
    orcid: 0000-0001-8927-1795
    affiliation:
      - ref: 1
  - name: Another Person
...
affiliations:
  - id: 1
    ...
    department: Precision Oncology Data Science
  - id: 2
    name: The Data Science Lab (DaSL)
  - id: 3
    name: Clinical Research Division
abstract: |
...
github: "fhdsl/quarto-dasl"
---

# Here's another h1 title
...
sample_data <- tibble(
  ...
  Age = rnorm(200, mean = 70, sd = 10)
)

# make a table
sample_data |>
  tbl_summary() |>
  modify_caption("Here is the title for this table.") |>
  as_gt() |>
  tab_options(
